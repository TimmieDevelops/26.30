...
namespace Offsets
{
	constexpr int32 GObjects          = 0x0E916540;
	constexpr int32 AppendString      = 0x00DE97C0;
	constexpr int32 GNames            = 0x0EAD7A40;
	constexpr int32 GWorld            = 0x0E93CCD8;
	constexpr int32 ProcessEvent      = 0x00D4200C;
	constexpr int32 ProcessEventIdx   = 0x0000004D;
    constexpr int32 FMemoryFree       = 0x00DE9140;
    constexpr int32 FMemoryRealloc    = 0x03E54B6C;
}

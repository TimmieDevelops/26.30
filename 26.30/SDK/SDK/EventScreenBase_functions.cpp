...
// (Event, Protected, BlueprintEvent)
// Parameters:
// const class UTexture2D*                 Icon                                                   (ConstParm, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UFortEventMoreInfoGroup::OnIconLoaded(const class UTexture2D* Icon)
{
	static class UFunction* Func = nullptr;
...
// const class FString&                    InOfferId                                              (Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UFortEventPurchaseLevelsModal::HandlePurchaseComplete(bool bSuccess, const TArray<struct FPurchasedItemInfo>& PurchasedItems, const class FString& InOfferId)
{
	static class UFunction* Func = nullptr;
	...
	Params::FortEventPurchaseLevelsModal_HandlePurchaseComplete Parms{};
...
void UFortEventPurchasePremiumTrackModal::HandlePurchaseComplete(bool bSuccess, const TArray<struct FPurchasedItemInfo>& PurchasedItems, const class FString& InOfferId)
{
	static class UFunction* Func = nullptr;
	...
	Params::FortEventPurchasePremiumTrackModal_HandlePurchaseComplete Parms{};
...
// (Final, Native, Private)
// Parameters:
// const class UFortAccountItemDefinition* AccountItemDef                                         (ConstParm, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
// (Event, Public, HasOutParams, BlueprintEvent)
// Parameters:
// const class FText&                      OutEventTimeRemaining                                  (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)

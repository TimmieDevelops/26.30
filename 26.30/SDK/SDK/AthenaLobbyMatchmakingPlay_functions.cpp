...
void UAthenaLobbyMatchmakingPlay_C::OnLoaded_9E042CC447B5A71DB17691907418A1C5(class UObject* Loaded)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AthenaLobbyMatchmakingPlay_C", "OnLoaded_9E042CC447B5A71DB17691907418A1C5");

	Params::AthenaLobbyMatchmakingPlay_C_OnLoaded_9E042CC447B5A71DB17691907418A1C5 Parms{};
...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// TSoftObjectPtr<class USoundBase>        NewSound                                               (BlueprintVisible, BlueprintReadOnly, Parm, HasGetValueTypeHash)

void UAthenaLobbyMatchmakingPlay_C::OnMatchmakingOverrideSoundSet(TSoftObjectPtr<class USoundBase> NewSound)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AthenaLobbyMatchmakingPlay_C", "OnMatchmakingOverrideSoundSet");

	Params::AthenaLobbyMatchmakingPlay_C_OnMatchmakingOverrideSoundSet Parms{};

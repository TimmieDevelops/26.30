...
// WidgetBlueprintGeneratedClass WBP_UIKit_Block_BackgroundCTA.WBP_UIKit_Block_BackgroundCTA_C
// 0x0058 (0x0378 - 0x0320)
class UWBP_UIKit_Block_BackgroundCTA_C final : public UWBP_UIKit_BlockBackground_Base_C
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_WBP_UIKit_Block_BackgroundCTA_C;    // 0x0320(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
public:
	void ExecuteUbergraph_WBP_UIKit_Block_BackgroundCTA(int32 EntryPoint);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"WBP_UIKit_Block_BackgroundCTA_C">();
	}
	static class UWBP_UIKit_Block_BackgroundCTA_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UWBP_UIKit_Block_BackgroundCTA_C>();
	}
};

...
public:
	...
	uint8                                         Pad_B8[0x4B0];                                     // 0x00B8(0x04B0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	class UReplicationGraphNode_GridSpatialization2D* GridNode;                                      // 0x0568(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UReplicationGraphNode_ActorList*        AlwaysRelevantNode;                                // 0x0570(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FConnectionAlwaysRelevantNodePair> AlwaysRelevantForConnectionList;                // 0x0578(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class AActor*>                         ActorsWithoutNetConnection;                        // 0x0588(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)

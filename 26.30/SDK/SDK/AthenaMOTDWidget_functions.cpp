...
// Function AthenaMOTDWidget.AthenaMOTDWidget_C.BP_PlayIntroAnimation
// (Event, Protected, BlueprintEvent)

void UAthenaMOTDWidget_C::BP_PlayIntroAnimation()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AthenaMOTDWidget_C", "BP_PlayIntroAnimation");

...
public:
	...
	TSoftClassPtr<class UClass>                   SoftClass;                                         // 0x0018(0x0020)(UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UObject*                                RawObject;                                         // 0x0038(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UObject*                                WrappedObject;                                     // 0x0040(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	TSoftObjectPtr<class UMetaData>               SoftObject;                                        // 0x0050(0x0020)(UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	struct FStructSerializerBuiltinTestStruct     Builtins;                                          // 0x00E0(0x00D0)(HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FStructSerializerArrayTestStruct       Arrays;                                            // 0x01B0(0x0060)(NativeAccessSpecifierPublic)
	struct FStructSerializerMapTestStruct         Maps;                                              // 0x0210(0x0140)(NativeAccessSpecifierPublic)
	struct FStructSerializerSetTestStruct         Sets;                                              // 0x0350(0x0140)(NativeAccessSpecifierPublic)
	struct FStructSerializerLWCTypesTest          LWCTypes;                                          // 0x0490(0x0360)(NativeAccessSpecifierPublic)
};

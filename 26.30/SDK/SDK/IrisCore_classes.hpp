...
public:
	void PreSendUpdate(const FSendUpdateParams& Params)
	{
		static void (*PreSendUpdateOG)(UReplicationSystem*, const FSendUpdateParams & Params) = decltype(PreSendUpdateOG)(InSDKUtils::GetImageBase() + 0x3E9BF70);
		return PreSendUpdateOG(this, Params);
	}
};

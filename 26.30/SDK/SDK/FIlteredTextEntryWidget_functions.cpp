...
void UFilteredTextEntryWidget_C::SetMinWidth(double InWidth)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FilteredTextEntryWidget_C", "SetMinWidth");

	Params::FilteredTextEntryWidget_C_SetMinWidth Parms{};
...
void UFilteredTextEntryWidget_C::ValidatePersistentID(const class FText& Text)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("FilteredTextEntryWidget_C", "ValidatePersistentID");

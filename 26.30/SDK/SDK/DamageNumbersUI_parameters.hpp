...
struct FortUserWidget_DamageNumbers_OnDamageNumberFinishedAnimating final
{
public:
	class UCommonUserWidget_DamageNumbers*        Widget;                                            // 0x0000(0x0008)(Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};

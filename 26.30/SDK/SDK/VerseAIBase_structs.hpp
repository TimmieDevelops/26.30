...
struct VerseAIBase::Ftuple_L_R final
{
public:
...
struct VerseAIBase::Ftuple_Lany_M_Kchar_R final
{
public:
...
struct VerseAIBase::Ftuple_Lfort__character_Mtuple_L_R_Mtuple_L_R_R final
{
public:
	...
	struct VerseAIBase::Ftuple_L_R                __verse_0x7D844C3C_Elem1;                          // 0x0008(0x0001)(InstancedReference, HasGetValueTypeHash)
	struct VerseAIBase::Ftuple_L_R                __verse_0x932BF92E_Elem2;                          // 0x0009(0x0001)(InstancedReference, HasGetValueTypeHash)
};

// VerseStruct VerseAIBase.tuple_Lfort__inventory__item__asset_Mint_R
// 0x0010 (0x0010 - 0x0000)
struct VerseAIBase::Ftuple_Lfort__inventory__item__asset_Mint_R final
{
public:

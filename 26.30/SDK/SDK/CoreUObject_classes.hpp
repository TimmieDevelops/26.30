...
public:
	...
	{
		return (this && this->IsA(StaticClass)) ? static_cast<T*>(this) : nullptr;
	}
	template<typename T>
	T* Cast(class UClass* StaticClass = T::StaticClass()) const 
	{
		return (this && this->IsA(StaticClass)) ? static_cast<const T*>(this) : nullptr;
	}

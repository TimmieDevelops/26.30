...
#include "GCN_Ascender_SpeedLines_classes.hpp"
#include "GCN_Ascender_SpeedLines_parameters.hpp"
...
void UGCN_Ascender_SpeedLines_C::OnBurst(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UParticleSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class ULegacyCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GCN_Ascender_SpeedLines_C", "OnBurst");

	Params::GCN_Ascender_SpeedLines_C_OnBurst Parms{};

...
#include "GCN_Burst_LandOnRail_classes.hpp"
#include "GCN_Burst_LandOnRail_parameters.hpp"
...
void UGCN_Burst_LandOnRail_C::OnBurstGeneric(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UFXSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class ULegacyCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GCN_Burst_LandOnRail_C", "OnBurstGeneric");

	Params::GCN_Burst_LandOnRail_C_OnBurstGeneric Parms{};

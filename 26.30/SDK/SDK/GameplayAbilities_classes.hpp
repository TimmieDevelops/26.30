...
public:
	...
	uint8                                         Pad_13C[0x1AC];                                    // 0x013C(0x01AC)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_550[0x230];                                    // 0x0550(0x0230)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_DD8[0x128];                                    // 0x0DD8(0x0128)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<uint8>                                 BlockedAbilityBindings;                            // 0x0F00(0x0010)(Net, ZeroConstructor, Transient, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_F10[0x128];                                    // 0x0F10(0x0128)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1238[0x10];                                    // 0x1238(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	struct FGameplayAbilitySpec* FindAbilitySpecFromHandle(struct FGameplayAbilitySpecHandle Handle)
	{
		static struct FGameplayAbilitySpec* (*FindAbilitySpecFromHandleOG)(UAbilitySystemComponent*, struct FGameplayAbilitySpecHandle Handle) = decltype(FindAbilitySpecFromHandleOG)(InSDKUtils::GetImageBase() + 0x1DDF10C);
		return FindAbilitySpecFromHandleOG(this, Handle);
	}
	...
	{
		static bool (*InternalTryActivateAbilityOG)(UAbilitySystemComponent*, struct FGameplayAbilitySpecHandle Handle, struct FPredictionKey InPredictionKey, class UGameplayAbility** OutInstancedAbility, void* OnGameplayAbilityEndedDelegate, const struct FGameplayEventData* TriggerEventData) = decltype(InternalTryActivateAbilityOG)(InSDKUtils::GetImageBase() + 0x68E7084);
		return InternalTryActivateAbilityOG(this, Handle, InPredictionKey, OutInstancedAbility, OnGameplayAbilityEndedDelegate, TriggerEventData);
	}

	struct FGameplayAbilitySpecHandle GiveAbility(const struct FGameplayAbilitySpec& Spec, struct FGameplayAbilitySpecHandle& Handle)
	{
		static struct FGameplayAbilitySpecHandle(*GiveAbilityOG)(UAbilitySystemComponent*, const struct FGameplayAbilitySpec& Spec, struct FGameplayAbilitySpecHandle& Handle) = decltype(GiveAbilityOG)(InSDKUtils::GetImageBase() + 0x68E489C);
		return GiveAbilityOG(this, Spec, Handle);
	}
};

...
// 0x05F0 (0x0950 - 0x0360)
struct FCommonInputActionData final : public FCommonInputActionDataBase
{
public:
	TMap<ECommonGamepadType, struct FCommonInputTypeInfo> GamepadInputTypeInfoOverrides;             // 0x0360(0x0050)(Edit, Protected, NativeAccessSpecifierProtected)
	struct FCommonInputTypeInfo                   GamepadInputTypeInfos[0x6];                        // 0x03B0(0x00F0)(Deprecated, Protected, NativeAccessSpecifierProtected)
};
